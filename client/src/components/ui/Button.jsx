...
const Button = ({ children, variant = "primary", type = "button", href, onClick, disabled }) => {
    // Determina los estilos del botón según el tipo de variante
    let buttonStyles;
    switch (variant) {
        case "primary":
            buttonStyles = "bg-primary hover:bg-primaryHover disabled:bg-blue-400 disabled:cursor-not-allowed text-white py-3 px-5 font-bold"
            break
        case "secondary":
