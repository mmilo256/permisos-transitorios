    ...
    return (
        <Container>
            ...
            <ul className="pl-6 mb-3">
                <li className="list-disc mb-2">Cédula de identidad del solicitante</li>
                ...
                <li className="list-disc mb-2">Declaración jurada simple que el solicitante no está afecto a prohibiciones del artículo n°4 ley 19.925 de alcoholes (sólo si la autorización es con venta y consumo de alcohol)</li>
                <li className="list-disc mb-2">Certificado de antecedentes para fines especiales del solicitante o representante legal en caso de organizaciones (sólo si la autorización es con venta y consumo de alcohol)</li>
            </ul>
            <p className="mb-3">
